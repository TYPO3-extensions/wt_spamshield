...
class tx_wtspamshield_method_abstract extends tslib_pibase {
	...
	function includeLocalLang() {
		...
		if($T3Version >= 6000000) {
			$llFile = \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('wt_spamshield') . 'Resources/Private/Language/locallang.xml';
			$LOCAL_LANG = \TYPO3\CMS\Core\Utility\GeneralUtility::readLLfile($llFile, $this->L->lang);
