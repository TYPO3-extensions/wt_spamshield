...
class tx_wtspamshield_AkismetObject {
	var $errors = array();
...
class tx_wtspamshield_AkismetHttpClient extends tx_wtspamshield_AkismetObject {
	...
	// Constructor
	function tx_wtspamshield_AkismetHttpClient($host, $blogUrl, $apiKey, $port = 80) {
		$this->host = $host;
		$this->port = $port;
...
class tx_wtspamshield_akismet extends tx_wtspamshield_AkismetObject {
	var $apiPort = 80;
	 ...
	 */
	function tx_wtspamshield_akismet($blogUrl, $apiKey, $comment) {
		$this->blogUrl = $blogUrl;
		$this->apiKey  = $apiKey;
		...
		$this->http = new tx_wtspamshield_AkismetHttpClient($this->akismetServer, $blogUrl, $apiKey);
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wt_spamshield/Classes/System/class.tx_wtspamshield_akismet.php']) {
	include_once ($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/wt_spamshield/Classes/System/class.tx_wtspamshield_akismet.php']);
}
